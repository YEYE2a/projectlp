          ...
          <div class="p-4 bg-light rounded shadow-sm">
            ...
            <form action="{{ route('proyectos.update', $proyecto->id) }}" method="POST">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="titulo" class="form-control" id="titulo" value="{{ $proyecto->titulo }}" required>
              </div>

              <div class="mb-3">
                <label for="descripcion" class="form-label">Descripción</label>
                <textarea name="descripcion" class="form-control" id="descripcion" rows="4" required>{{ $proyecto->descripcion }}</textarea>
              </div>
